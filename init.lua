...
-- Move tabs with C-left and C-right
vim.keymap.set('n', '<C-left>', ':tabprevious<CR>', { desc = 'Move to [P]revious tab' })
...

  {
    ...
    config = function()
      require('copilot').setup {
        ...
        suggestion = { enabled = true }, -- This is set to false due to copilot cmp
